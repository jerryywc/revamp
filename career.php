...
<html>
		...
		<nav class="navbar navbar-fixed-top navbar-expand-lg navbar-light">
	  		...
	  		<div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
			    <ul class="navbar-nav mx-auto">
			      	...
			      	<li class="nav-item active rightborder text-left">
	...
	<div class="main py-0" >
		<div class="row mx-0 px-3">
      		<div class="col-12" style="background-color:white; height:60vh">
      			<h3 class="text-center text-uppercase py-3">Career with Posim</h3>
      			<div  id="content">
      			</div>
      		</div>
      	</div>
