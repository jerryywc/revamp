	...
	<div class="main py-0" >
		<div class="row mx-0 px-3">
      		<div class="col-12" style="background-color:white; ">
      			<h3 class="text-center text-uppercase py-3">Gallery</h3>
      			<div  id="content">
      				<div class='embedsocial-album' data-ref="f996253aeb8ca608e1d8641f010c320a6edfca1a"></div><script>(function(d, s, id){var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ei.js"; d.getElementsByTagName("head")[0].appendChild(js);}(document, "script", "EmbedSocialScript"));</script>
      			</div>
      		</div>
      	</div>
    </div><!--EndOf main-->
